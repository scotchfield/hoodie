...
class TestTutorial extends PHPUnit_Framework_TestCase {
    ...
    /**
     * @covers HQTutorial::__construct
     */
    public function test_tutorial_new() {
        $this->assertNotFalse( $this->ag->c( 'hq_tutorial' ) );
    }
